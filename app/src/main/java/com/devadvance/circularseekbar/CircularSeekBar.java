...
public class CircularSeekBar extends View {
	...
	private static final float DEFAULT_CIRCLE_STROKE_WIDTH = 2f;
    private static final float DEFAULT_CIRCLE_PROGRESS_STROKE_WIDTH = 5f;
    ...
    /**
     * The width of the circle progress section (in pixels).
     */
    private float mCircleProgressStrokeWidth;
	...
	private void initAttributes(TypedArray attrArray) {
        ...
        mCircleProgressStrokeWidth = (float) (attrArray.getFloat(R.styleable.CircularSeekBar_circle_progress_stroke_width, DEFAULT_CIRCLE_PROGRESS_STROKE_WIDTH) * DPTOPX_SCALE);
	...
	private void initPaints() {
		...
		mCircleProgressPaint.setStrokeWidth(mCircleProgressStrokeWidth);
